...
define("TASKS_FILE", "tasks.json");//this loadTask() function will load tasks from the tasks.json file
...
function loadTasks(): array {
    ...
    return $data ? json_decode($data, true) : [];//json_decode() function will decode the JSON data and return it as an associative array
}
// Load tasks from the tasks.json file
$tasks = loadTasks();

// TODO: Create a function to save tasks to the tasks.json file
// This function should take an array of tasks and save it back to the task.json file

function saveTasks(array $tasks) : void {
    file_put_contents(TASKS_FILE, json_encode($tasks, JSON_PRETTY_PRINT));//JSON_PRETTY_PRINT will print JSON data more readable
}
